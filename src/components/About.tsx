      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          >
            ...
            <div className="w-full mx-auto relative" style={{ aspectRatio: '9/16', maxWidth: '400px' }}>
              {/* Decorative frame */}
              <motion.div 
            ...
            <div className="space-y-8">
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-2">My Self</h3>
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-6 rounded-xl bg-white bg-opacity-5 border border-white border-opacity-10 hover:border-primary hover:border-opacity-30 transition-colors">
                    <h4 className="text-xl font-bold mb-3 gradient-text">Notable Projects</h4>
                  ...
                  <div className="p-6 rounded-xl bg-white bg-opacity-5 border border-white border-opacity-10 hover:border-primary hover:border-opacity-30 transition-colors">
                    <h4 className="text-xl font-bold mb-3 gradient-text">Key Skills</h4>
