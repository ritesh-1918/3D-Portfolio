...
const certificateData: Certificate[] = [
  {
    id: '1',
    name: 'AI Masterclass - Multi-Agent AI System',
  ...
  },
  {
    id: '17',
    name: 'C++ Certificate',
    image: '/images/certificates/C++ LU-1.png'
  },
  {
    id: '18',
  ...
  },
  {
    ...
    image: '/images/certificates/JAVA LU-1.png'
  },
  {
    id: '21',
    name: 'LETSupgrade C++',
  ...
  },
  {
    ...
    image: '/images/certificates/Mongo dB LU -1.png'
  },
  {
    id: '23',
  ...
  return (
    <section id="certificates" className="py-20 bg-background bg-opacity-50">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl font-bold gradient-text mb-4">My Certificates</h2>
                ...
                >
                  {applyGlass(
                    <div className="p-4 h-full flex flex-col">
                      ...
                      <h3 className="text-sm font-medium text-center truncate">{certificate.name}</h3>
                    </div>,
