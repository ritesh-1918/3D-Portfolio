...
const Footer = () => {
  ...
  return (
    <footer className="py-10 border-t border-white border-opacity-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold gradient-text mb-4">Ritesh</h3>
            <p className="text-gray-300 mb-4 max-w-md">
              A passionate developer focused on creating modern, user-friendly web applications
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:your-email@example.com" className="text-gray-300 hover:text-primary transition-colors">your-email@example.com</a>
              </li>
              <li className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="text-primary" viewBox="0 0 16 16">
        ...
        <div className="mt-10 pt-6 border-t border-white border-opacity-10 text-center">
          <p className="text-gray-400">
            © {currentYear} Ritesh Bonthalakoti. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
