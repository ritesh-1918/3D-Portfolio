      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <motion.h1 
              variants={fadeInUp}
              className="text-2xl md:text-3xl lg:text-4xl font-bold mb-6 font-poppins"
            >
            ...
            >
              {[
                { text: 'Entrepreneur', color: '#00ff88' },
                { text: 'Student', color: '#7000ff' },
                { text: 'Innovator', color: '#ff3466' }
              ].map((item, index) => (
                <motion.span
                  key={index}
                  variants={fadeInUp}
            ...
            >
              ...
              <motion.a
                href="https://www.linkedin.com/in/ritesh1908/"
                target="_blank"
                rel="noopener noreferrer"
                variants={fadeInUp}
                whileHover={{ scale: 1.2, y: -5 }}
              ...
              <motion.a
                href="https://www.instagram.com/ritesh_19180/"
                target="_blank"
                rel="noopener noreferrer"
                variants={fadeInUp}
                whileHover={{ scale: 1.2, y: -5 }}
              ...
              <motion.a
                href="https://x.com/MadhaviBonthal1"
                target="_blank"
                rel="noopener noreferrer"
                variants={fadeInUp}
                whileHover={{ scale: 1.2, y: -5 }}
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96">
              {/* Animated circular frame with glow */}
              <motion.div 
