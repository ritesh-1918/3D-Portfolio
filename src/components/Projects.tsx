  ...
  const projects: Project[] = [
    {
      ...
      images: [
        '/images/projects/RaceXplorer1.jpg',
        '/images/projects/RaceXplorer2.jpg',
        '/images/projects/RaceXplorer3.jpg',
        '/images/projects/RaceXplorer4.jpg',
    ...
    },
    {
      ...
      images: [
        ...
        '/images/projects/3D Portfolio2.jpg',
        '/images/projects/3D Portfolio3.jpg'
      ],
      links: {
    ...
    },
    {
      ...
      description: 'A modern e-commerce store with advanced features.',
      longDescription: 'A fully functional e-commerce platform with product catalog, shopping cart, secure checkout, and user accounts. Includes advanced features like product recommendations and inventory management.',
      tags: ['E-Commerce', 'Shopping', 'Payments'],
      skills: ['React', 'Node.js', 'Stripe API', 'MongoDB'],
      images: ['/images/projects/project1.svg'],
      links: {
        github: 'https://github.com/ritesh-1918/ecommerce-store',
    ...
    },
    {
      ...
      images: ['/images/projects/project2.svg'],
      links: {
    ...
    },
    {
      ...
      images: ['/images/projects/project3.svg'] ,
      links: {
    ...
    },
    {
      ...
      description: 'Interactive tool to calculate and optimize home satisfaction metrics',
      longDescription: 'The House Happiness Calculator is an innovative tool that helps users evaluate and improve their home satisfaction. It analyzes various factors like space utilization, natural light, noise levels, and proximity to amenities to generate a comprehensive happiness score. Users can adjust different parameters to see how specific changes would impact their overall home satisfaction.',
      tags: ['Calculator', 'Home', 'Lifestyle', 'Analytics'],
      skills: ['React', 'JavaScript', 'Chart.js', 'Tailwind CSS'],
      images: ['/images/projects/house-happiness.svg'],
      links: {
        github: 'https://github.com/ritesh-1918/house-happiness-calculator',
        live: 'https://house-happiness.demo.com'
      }
    }
  ];
  ...
  return (
    <section id="projects" className="py-8">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl font-bold gradient-text mb-3">My Projects</h2>
        ...
        <div className="relative px-8 md:px-12">
          ...
          <AnimatePresence mode="wait">
            <motion.div 
              ...
              transition={{ duration: 0.5 }}
              className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4" // Reduced gap from gap-6 to gap-4
            >
